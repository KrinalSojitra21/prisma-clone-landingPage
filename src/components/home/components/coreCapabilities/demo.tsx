...
//       <div
//         ref={containerRef}
//         className="h-full lg:max-h-[670px] lg:overflow-y-scroll bg-black-900 mt-[60px] max-w-[1240px] hide-scrollbar rounded-3xl"
//       >
//         <div className="h-[300vh] px-[145px] hidden lg:block">
//           <div className="sticky top-0 left-0 overflow-hidden flex flex-col">
//             <div className="hidden md:flex justify-between items-center gap-8 bg-black-900 py-12 px-[90px]">
